...
# Based on: https://pvpmc.sandia.gov/ and https://pvlib-python.readthedocs.io/en/stable/.
# 
...
plt.grid(True, zorder = 0);
plt.tight_layout;
plt.savefig('3_Error_DCPower_SysA.eps')
...
plt.grid(True, zorder = 0);
plt.tight_layout;
plt.savefig('3_Error_DCPower_SysB.eps')
...
plt.grid(True, zorder = 0);
plt.tight_layout;
plt.savefig('3_Error_ACPower_SysA.eps')
...
plt.grid(True, zorder = 0);
plt.tight_layout;
plt.savefig('3_Error_ACPower_SysB.eps')
...
plt.grid(True, zorder = 0);
plt.tight_layout;
plt.savefig('3_Error_Energy_SysA.eps')
...
plt.grid(True, zorder = 0);
plt.tight_layout;
plt.savefig('3_Error_Energy_SysB.eps')
